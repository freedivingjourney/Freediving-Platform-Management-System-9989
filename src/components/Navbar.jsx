...
const { FiHome, FiBook, FiUsers, FiCalendar, FiShoppingBag, FiMail, FiUser, FiActivity, FiTarget, FiCompass, FiHeart, FiEdit3, FiSettings, FiLogOut, FiMenu, FiX, FiShield } = FiIcons;
